...
class DiscordBattleShip {
    ...
    async createGame(message) {
        ...
        if (!opponent)
            return message.channel.send("Please mention another SAILOR to battle!"); // If there is no opponent, require them to define one
        ...
        if(challenger.roles.cache.has('876069157161029632') == false || opponent.roles.cache.has('876069157161029632') == false) 
            return message.channel.send("Make sure you both payed your ticket by sending SAIL to the bot (check your roles!)");
        
        if(challenger.roles.cache.has('876068848456069150') != false || opponent.roles.cache.has('876068848456069150') != false) 
            return message.channel.send("Make sure you both finished your games! (check your roles!)");
        
        const accept = await message.channel.send(`Hey ${opponent}, ${challenger.user.tag} just challenged you to a game of SAIL Battle Ship. Do you accept?`); // Ask if the user would like to play 
        ...
        challenger.roles.add("876068848456069150") 
        opponent.roles.add("876068848456069150")
            
        challenger.roles.remove("876069157161029632")
        opponent.roles.remove("876069157161029632")
        ...
        return message.channel.send("In progress. Removed Payed Role and gave INGAME role");
